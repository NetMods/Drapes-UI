...
const OrbitalBackground = ({
  ...
  // Draw: runs on prop changes (no shader recompilation)
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Create per-draw resources (texture + fbo depend on canvas size)
      ...
      // Upload dot data to reusable buffers
      ...
      gl.uniform2f(locs.resolution, w * dpr, h * dpr);
      ...
      // Only clean up per-draw resources
  ...
  // Resize handler (stable, always calls latest draw)
  useEffect(() => {
