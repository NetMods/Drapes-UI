            ...
            <div className='mt-4'>
              <div className="flex w-full mb-4 font-sans">
                <button
                  ...
                  className={`max-sm:text-[0.9rem] outline-0 cursor-pointer flex justify-center items-center font-medium gap-2 px-4 py-1 w-1/2 rounded-l-lg ${activeTab === 'ts'
                ...
                <button
                  ...
                  className={`max-sm:text-[0.9rem] outline-0 cursor-pointer flex justify-center items-center font-medium gap-2 px-4 py-1 w-1/2 rounded-r-lg ${activeTab === 'js'
