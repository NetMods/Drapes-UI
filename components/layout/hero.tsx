  ...
  return (
    <div className="flex justify-center text-base-content gap-10 px-10 min-[1250px]:gap-40">
      <div className="my-auto">
        ...
        <p className="mt-5 text-lg max-md:text-center text-base-content/70 max-w-130">Independent components made using Tailwind and JSX and easily integrate with your React JS and Next JS app.</p>
